          ...
          >
            <ol className="bg-base bg-op-70! backdrop-blur-md p-2 rounded-lg color-base text-base">
              ...
              <li className="flex gap-2 items-center">
                <a
                  href="https://github.com/zhujun-123/hotspot-web"
                >
                  <img
                    alt="GitHub stars badge"
                    src="https://img.shields.io/github/stars/zhujun-123/hotspot-web?logo=github&style=flat&labelColor=%235e3c40&color=%23614447"
                  />
                </a>
                <a
                  href="https://github.com/zhujun-123/hotspot-web/fork"
                >
                  <img
                    alt="GitHub forks badge"
                    src="https://img.shields.io/github/forks/zhujun-123/hotspot-web?logo=github&style=flat&labelColor=%235e3c40&color=%23614447"
                  />
                </a>
              </li>
            </ol>
